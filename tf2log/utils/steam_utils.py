...
class SteamUtils:
    __STEAMWORKS_SERVER_LIST_ENDPOINT = "https://api.steampowered.com/IGameServersService/GetServerList/v1/"
    ...
    async def get_server_info(self,
        ...
        async with aiohttp_session.get(self.__STEAMWORKS_SERVER_LIST_ENDPOINT,
